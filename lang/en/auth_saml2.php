...
$string['defaultuserauth'] = 'Default authentication method for new users';
$string['defaultuserauth_help'] = 'Authentication method assigned to automatically created users when no authentication method is supplied by the attribute mapping. Only enabled authentication methods are available, excluding "No login". Existing users are not changed.';
